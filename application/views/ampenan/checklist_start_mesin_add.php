...
<div class="container-fluid">
    ...
    <di class="row">
        <div class="col-lg-12">
            <form action="<?= base_url('checklist_start_mesin/add'); ?>" method="POST">
                <div id="hidden_field">
                    <input type="hidden" name="input[pk_checklist_start_mesin]" value="<?= 'PBP' . date('dhs'); ?>">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-5">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="input[mesin_layak_operasi]" id="mesin_layak_operasi1" value="Normal">
                                                    <label class="form-check-label" for="mesin_layak_operasi1">Normal</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="input[mesin_layak_operasi]" id="mesin_layak_operasi2" value="Tidak Normal">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-5">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="input[ppm_a]" id="ppm_a1" value="Normal">
                                                    <label class="form-check-label" for="ppm_a1">Normal</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="input[ppm_a]" id="ppm_a2" value="Tidak Normal">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-5">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="input[ppm_b]" id="ppm_b1" value="Normal">
                                                    <label class="form-check-label" for="ppm_b1">Normal</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="input[ppm_b]" id="ppm_b2" value="Tidak Normal">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-5">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="input[ppm_c]" id="ppm_c1" value="Normal">
                                                    <label class="form-check-label" for="ppm_c1">Normal</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="input[ppm_c]" id="ppm_c2" value="Tidak Normal">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-5">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="input[ppm_d]" id="ppm_d1" value="Normal">
                                                    <label class="form-check-label" for="ppm_d1">Normal</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="input[ppm_d]" id="ppm_d2" value="Tidak Normal">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-5">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="input[papm_a]" id="papm_a1" value="Normal">
                                                    <label class="form-check-label" for="papm_a1">Normal</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="input[papm_a]" id="papm_a2" value="Tidak Normal">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-5">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="input[papm_b]" id="papm_b1" value="Normal">
                                                    <label class="form-check-label" for="papm_b1">Normal</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="input[papm_b]" id="papm_b2" value="Tidak Normal">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-5">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="input[papm_c]" id="papm_c1" value="Normal">
                                                    <label class="form-check-label" for="papm_c1">Normal</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="input[papm_c]" id="papm_c2" value="Tidak Normal">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-5">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="input[papm_d]" id="papm_d1" value="Normal">
                                                    <label class="form-check-label" for="papm_d1">Normal</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="input[papm_d]" id="papm_d2" value="Tidak Normal">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-5">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="input[pk_a]" id="pk_a1" value="Normal">
                                                    <label class="form-check-label" for="pk_a1">Normal</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="input[pk_a]" id="pk_a2" value="Tidak Normal">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-5">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="input[pk_b]" id="pk_b1" value="Normal">
                                                    <label class="form-check-label" for="pk_b1">Normal</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="input[pk_b]" id="pk_b2" value="Tidak Normal">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-5">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="input[pk_c]" id="pk_c1" value="Normal">
                                                    <label class="form-check-label" for="pk_c1">Normal</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="input[pk_c]" id="pk_c2" value="Kelainan">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-5">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="input[pk_d]" id="pk_d2" value="Normal">
                                                    <label class="form-check-label" for="pk_d2">Normal</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="input[pk_d]" id="pk_d1" value="Tidak Normal">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-5">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="input[buka_ki]" id="buka_ki1" value="Normal">
                                                    <label class="form-check-label" for="buka_ki1">Normal</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="input[buka_ki]" id="buka_ki2" value="Tidak Normal">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-5">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="input[fw_a]" id="fw_a1" value="Normal">
                                                    <label class="form-check-label" for="fw_a1">Normal</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="input[fw_a]" id="fw_a2" value="Tidak Normal">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-5">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="input[fw_b]" id="fw_b1" value="Normal">
                                                    <label class="form-check-label" for="fw_b1">Normal</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="input[fw_b]" id="fw_b2" value="Tidak Normal">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-5">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="input[fw_c]" id="fw_c1" value="Normal">
                                                    <label class="form-check-label" for="fw_c1">Normal</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="input[fw_c]" id="fw_c2" value="Tidak Normal">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-5">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="input[turning_gear]" id="turning_gear1" value="Normal">
                                                    <label class="form-check-label" for="turning_gear1">Normal</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="input[turning_gear]" id="turning_gear2" value="Tidak Normal">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-5">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="input[start_mesin_pompa_a]" id="start_mesin_pompa_a1" value="Normal">
                                                    <label class="form-check-label" for="start_mesin_pompa_a1">Normal</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="input[start_mesin_pompa_a]" id="start_mesin_pompa_a2" value="Tidak Normal">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-5">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="input[start_mesin_pompa_b]" id="start_mesin_pompa_b1" value="Normal">
                                                    <label class="form-check-label" for="start_mesin_pompa_b1">Normal</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="input[start_mesin_pompa_b]" id="start_mesin_pompa_b2" value="Tidak Normal">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-5">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="input[start_mesin_pompa_c]" id="start_mesin_pompa_c1" value="Normal">
                                                    <label class="form-check-label" for="start_mesin_pompa_c1">Normal</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="input[start_mesin_pompa_c]" id="start_mesin_pompa_c2" value="Tidak Normal">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-5">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="input[start_mesin_pompa_d]" id="start_mesin_pompa_d1" value="Normal">
                                                    <label class="form-check-label" for="start_mesin_pompa_d1">Normal</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="input[start_mesin_pompa_d]" id="start_mesin_pompa_d2" value="Tidak Normal">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-5">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="input[tutup_ki]" id="tutup_ki1" value="Normal">
                                                    <label class="form-check-label" for="tutup_ki1">Normal</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="input[tutup_ki]" id="tutup_ki2" value="Tidak Normal">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-5">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="input[cek_tekanan_udara]" id="cek_tekanan_udara1" value="Normal">
                                                    <label class="form-check-label" for="cek_tekanan_udara1">Normal</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="input[cek_tekanan_udara]" id="cek_tekanan_udara2" value="Tidak Normal">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-5">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="input[cek_sumber_tegangan]" id="cek_sumber_tegangan1" value="Normal">
                                                    <label class="form-check-label" for="cek_sumber_tegangan1">Normal</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="input[cek_sumber_tegangan]" id="cek_sumber_tegangan2" value="Tidak Normal">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-5">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="input[pbb_d]" id="pbb_d1" value="Normal">
                                                    <label class="form-check-label" for="pbb_d1">Normal</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="input[pbb_d]" id="pbb_d2" value="Tidak Normal">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-5">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="input[pbb_e]" id="pbb_e1" value="Normal">
                                                    <label class="form-check-label" for="pbb_e1">Normal</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="input[pbb_e]" id="pbb_e2" value="Tidak Normal">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-5">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="input[pastikan_mesin_aman]" id="pastikan_mesin_aman1" value="Normal">
                                                    <label class="form-check-label" for="pastikan_mesin_aman1">Normal</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="input[pastikan_mesin_aman]" id="pastikan_mesin_aman2" value="Tidak Normal">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-5">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="input[start_mesin_pertahankan_a]" id="start_mesin_pertahankan_a1" value="Normal">
                                                    <label class="form-check-label" for="start_mesin_pertahankan_a1">Normal</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="input[start_mesin_pertahankan_a]" id="start_mesin_pertahankan_a2" value="Tidak Normal">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-5">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="input[start_mesin_pertahankan_b]" id="start_mesin_pertahankan_b1" value="Normal">
                                                    <label class="form-check-label" for="start_mesin_pertahankan_b1">Normal</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="input[start_mesin_pertahankan_b]" id="start_mesin_pertahankan_b2" value="Tidak Normal">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-5">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="input[start_mesin_pertahankan_c]" id="start_mesin_pertahankan_c1" value="Normal">
                                                    <label class="form-check-label" for="start_mesin_pertahankan_c1">Normal</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="input[start_mesin_pertahankan_c]" id="start_mesin_pertahankan_c2" value="Tidak Normal">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-5">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="input[start_mesin_pertahankan_d]" id="start_mesin_pertahankan_d1" value="Normal">
                                                    <label class="form-check-label" for="start_mesin_pertahankan_d1">Normal</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="input[start_mesin_pertahankan_d]" id="start_mesin_pertahankan_d2" value="Tidak Normal">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-5">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="input[start_mesin_pertahankan_e]" id="start_mesin_pertahankan_e1" value="Normal">
                                                    <label class="form-check-label" for="start_mesin_pertahankan_e1">Normal</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="input[start_mesin_pertahankan_e]" id="start_mesin_pertahankan_e2" value="Tidak Normal">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-5">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="input[buka_ki_cek_semburan]" id="buka_ki_cek_semburan1" value="Normal">
                                                    <label class="form-check-label" for="buka_ki_cek_semburan1">Normal</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="input[buka_ki_cek_semburan]" id="buka_ki_cek_semburan2" value="Tidak Normal">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-5">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="input[putaran_idle_a]" id="putaran_idle_a1" value="Normal">
                                                    <label class="form-check-label" for="putaran_idle_a1">Normal</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="input[putaran_idle_a]" id="putaran_idle_a2" value="Tidak Normal">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-5">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="input[putaran_idle_b]" id="putaran_idle_b1" value="Normal">
                                                    <label class="form-check-label" for="putaran_idle_b1">Normal</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="input[putaran_idle_b]" id="putaran_idle_b2" value="Tidak Normal">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-5">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="input[putaran_idle_c]" id="putaran_idle_c1" value="Normal">
                                                    <label class="form-check-label" for="putaran_idle_c1">Normal</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="input[putaran_idle_c]" id="putaran_idle_c2" value="Tidak Normal">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-5">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="input[putaran_idle_d]" id="putaran_idle_d1" value="Normal">
                                                    <label class="form-check-label" for="putaran_idle_d1">Normal</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="input[putaran_idle_d]" id="putaran_idle_d2" value="Tidak Normal">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-5">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="input[putaran_idle_e]" id="putaran_idle_e1" value="Normal">
                                                    <label class="form-check-label" for="putaran_idle_e1">Normal</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="input[putaran_idle_e]" id="putaran_idle_e2" value="Tidak Normal">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-5">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="input[putaran_idle_f]" id="putaran_idle_f1" value="Normal">
                                                    <label class="form-check-label" for="putaran_idle_f1">Normal</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="input[putaran_idle_f]" id="putaran_idle_f2" value="Tidak Normal">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-5">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="input[putaran_idle_g]" id="putaran_idle_g1" value="Normal">
                                                    <label class="form-check-label" for="putaran_idle_g1">Normal</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="input[putaran_idle_g]" id="putaran_idle_g2" value="Tidak Normal">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-5">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="input[putaran_idle_h]" id="putaran_idle_h1" value="Normal">
                                                    <label class="form-check-label" for="putaran_idle_h1">Normal</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="input[putaran_idle_h]" id="putaran_idle_h2" value="Tidak Normal">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-5">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="input[putaran_idle_i]" id="putaran_idle_i1" value="Normal">
                                                    <label class="form-check-label" for="putaran_idle_i1">Normal</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="input[putaran_idle_i]" id="putaran_idle_i2" value="Tidak Normal">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-5">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="input[mesin_siap_dibebani]" id="mesin_siap_dibebani1" value="Normal">
                                                    <label class="form-check-label" for="mesin_siap_dibebani1">Normal</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="input[mesin_siap_dibebani]" id="mesin_siap_dibebani2" value="Tidak Normal">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-5">
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="input[selama_mulai_pembebanan]" id="selama_mulai_pembebanan1" value="Normal">
                                                    <label class="form-check-label" for="selama_mulai_pembebanan1">Normal</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="input[selama_mulai_pembebanan]" id="selama_mulai_pembebanan2" value="Tidak Normal">
