<!-- <div class="container-fluid">
    <div class="row">
        <div class="col-lg-12">
            ...
            <a class="btn btn-primary  my-4" href="<?= base_url() . 'log_ampenan_zav_generator/add'; ?>"> Input Data </a>
    ...
    <form action="<?= base_url('Log_ampenan_zav_generator/report'); ?>" method="POST" target="_blank">
        <div class="row">
            <div class="col-sm-8">
                <div class="row">
                    <div class="col-sm-2">
                        <a href="<?php echo (base_url('Log_ampenan_zav_generator/add')) ?>" class="btn btn-primary   mb-3">Data Baru</a>
                    </div>
                    <div class="col-sm-8">
                        <div class="row">
                            <div class="col-sm-6">
