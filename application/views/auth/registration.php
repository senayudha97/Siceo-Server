                        ...
                        <form class="user" method="POST" action="<?= base_url('auth/registration'); ?>">
                            <div class="form-group row">
                                <div class="col-sm mb-3 mb-sm-0" id="hidden_field">
                                    <input type="text" value="" class="form-control " id="role_id" name="role_id" placeholder="role_id">
                                    <input type="text" value="1" class="form-control" id="menu_style" name="menu_style">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <div class="col-sm mb-3 mb-sm-0">
                                    <select name="unit1" class="form-control " id="unit1">
                            ...
                            <div class="form-group row">
                                <div class="col-sm mb-3 mb-sm-0">
                                    <select name="unit2" class="form-control  " id="unit2">
                            ...
                            <div class="form-group row">
                                <div class="col-sm mb-3 mb-sm-0">
                                    <select name="unit3" class="form-control  " id="unit3">
                            ...
                            <div class="form-group row">
                                <div class="col-sm mb-3 mb-sm-0">
                                    <input type="text" name="wa" class="form-control  " id="name" placeholder="Nomor WhatsApp">
                                    <?= form_error('name', '<small class="text-danger pl-3">', '</small>'); ?>
                                </div>
                            </div>
